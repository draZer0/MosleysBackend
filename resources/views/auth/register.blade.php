                ...
                <div class="col-lg-4 col-md-6 ml-auto mr-auto">
                    <div class="card card-signup text-center">
                        <div class="card-header ">
                            <h4 class="card-title">{{ __('Registreren') }}</h4>
                        </div>
                        <div class="card-body ">
                            <form class="form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="input-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input name="name" type="text" class="form-control" placeholder="Naam" value="{{ old('name') }}" required autofocus>
                                    @if ($errors->has('name'))
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="password_confirmation" type="password" class="form-control" placeholder="Wachtwoord bevestigen" required>
                                ...
                                <div class="form-check text-left">
                                    <label class="form-check-label">
                                        ...
                                        <span class="form-check-sign"></span>
                                            {{ __('Ik ben een medewerker van Mosley\'s') }}
                                    </label>
